...
valid to stream file contents using a named pipe.  Default: `false`.
 */
  @Deprecated public Boolean streamable;
...
the underlying process parameter.
 */
  @Deprecated public Object source;
 ...
 */
   ...
   */
  public WorkflowOutputParameter(Object type, CharSequence label, CharSequence description, Boolean streamable, Any default$, CharSequence id, Binding outputBinding, Object source, LinkMergeMethod linkMerge) {
    this.type = type;
    this.label = label;
...
If not specified, the default method is "merge_nested".
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WorkflowOutputParameter>
    ...
    /** Sets the value of the 'type' field */
    public WorkflowOutputParameter.Builder setType(Object value) {
    ...
    /** Sets the value of the 'label' field */
    public WorkflowOutputParameter.Builder setLabel(CharSequence value) {
    ...
    /** Sets the value of the 'description' field */
    public WorkflowOutputParameter.Builder setDescription(CharSequence value) {
    ...
    /** Sets the value of the 'streamable' field */
    public WorkflowOutputParameter.Builder setStreamable(Boolean value) {
    ...
    /** Sets the value of the 'id' field */
    public WorkflowOutputParameter.Builder setId(CharSequence value) {
    ...
    /** Sets the value of the 'source' field */
    public WorkflowOutputParameter.Builder setSource(Object value) {
    ...
    public WorkflowOutputParameter build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (Object) defaultValue(fields()[0]);
        ...
        record.streamable = fieldSetFlags()[3] ? this.streamable : (Boolean) defaultValue(fields()[3]);
        ...
        record.source = fieldSetFlags()[7] ? this.source : (Object) defaultValue(fields()[7]);
