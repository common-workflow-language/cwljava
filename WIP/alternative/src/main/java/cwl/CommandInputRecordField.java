 ...
 */
  @Deprecated public CharSequence doc;
  /** The field type
 */
   ...
   */
  public CommandInputRecordField(CharSequence name, CharSequence doc, Object type, CommandLineBinding inputBinding) {
    this.name = name;
    this.doc = doc;
    this.type = type;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: doc = (CharSequence)value$; break;
    case 2: type = (Object)value$; break;
   ...
   * @param value the value to set.
   */
  public void setDoc(CharSequence value) {
    this.doc = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CommandInputRecordField>
    ...
    /** Sets the value of the 'name' field */
    public CommandInputRecordField.Builder setName(CharSequence value) {
    ...
    /** Sets the value of the 'doc' field */
    public CommandInputRecordField.Builder setDoc(CharSequence value) {
    ...
    /** Sets the value of the 'type' field */
    public CommandInputRecordField.Builder setType(Object value) {
    ...
    public CommandInputRecordField build() {
      try {
        ...
        record.doc = fieldSetFlags()[1] ? this.doc : (CharSequence) defaultValue(fields()[1]);
        record.type = fieldSetFlags()[2] ? this.type : (Object) defaultValue(fields()[2]);
