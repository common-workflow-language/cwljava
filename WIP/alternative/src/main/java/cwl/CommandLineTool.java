...
executable.
 */
  @Deprecated public Object baseCommand;
  /** Command line bindings which are not directly associated with input parameters.
 */
  @Deprecated public java.util.List<Object> arguments;
  /** A path to a file whose contents must be piped into the command's
standard input stream.
 */
  @Deprecated public Object stdin;
...
characters (such as the path separator `/`) it is an error.
 */
  @Deprecated public Object stdout;
  /** Exit codes that indicate the process completed successfully.
 */
  @Deprecated public java.util.List<Integer> successCodes;
  /** Exit codes that indicate the process failed due to a possibly
temporary condition, where excuting the process with the same
runtime environment and inputs may produce different results.
 */
  @Deprecated public java.util.List<Integer> temporaryFailCodes;
  ...
  @Deprecated public java.util.List<Integer> permanentFailCodes;
   ...
   */
  public CommandLineTool(CharSequence id, java.util.List<CommandInputParameter> inputs, java.util.List<CommandOutputParameter> outputs, java.util.List<Object> requirements, java.util.List<Any> hints, CharSequence label, CharSequence description, CharSequence cwlVersion, CharSequence class$, Object baseCommand, java.util.List<Object> arguments, Object stdin, Object stdout, java.util.List<Integer> successCodes, java.util.List<Integer> temporaryFailCodes, java.util.List<Integer> permanentFailCodes) {
    this.id = id;
    this.inputs = inputs;
  ...
  public void put(int field$, Object value$) {
    ...
    case 9: baseCommand = (Object)value$; break;
    case 10: arguments = (java.util.List<Object>)value$; break;
    case 11: stdin = (Object)value$; break;
    case 12: stdout = (Object)value$; break;
    case 13: successCodes = (java.util.List<Integer>)value$; break;
    case 14: temporaryFailCodes = (java.util.List<Integer>)value$; break;
    case 15: permanentFailCodes = (java.util.List<Integer>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
...
executable.
   * @param value the value to set.
   */
  public void setBaseCommand(Object value) {
   ...
   * @param value the value to set.
   */
  public void setArguments(java.util.List<Object> value) {
...
standard input stream.
   * @param value the value to set.
   */
  public void setStdin(Object value) {
    this.stdin = value;
  }
...
characters (such as the path separator `/`) it is an error.
   ...
   * @param value the value to set.
   */
  public void setSuccessCodes(java.util.List<Integer> value) {
...
runtime environment and inputs may produce different results.
   */
  public java.util.List<Integer> getTemporaryFailCodes() {
...
runtime environment and inputs may produce different results.
   * @param value the value to set.
   */
  public void setTemporaryFailCodes(java.util.List<Integer> value) {
   ...
   * Exit codes that indicate the process failed due to a permanent logic error, where excuting the process with the same runtime environment and same inputs is expected to always fail.   */
  public java.util.List<Integer> getPermanentFailCodes() {
   ...
   */
  public void setPermanentFailCodes(java.util.List<Integer> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CommandLineTool>
    ...
    private java.util.List<Integer> temporaryFailCodes;
    private java.util.List<Integer> permanentFailCodes;
    ...
    /** Sets the value of the 'id' field */
    public CommandLineTool.Builder setId(CharSequence value) {
    ...
    /** Sets the value of the 'requirements' field */
    public CommandLineTool.Builder setRequirements(java.util.List<Object> value) {
    ...
    /** Sets the value of the 'label' field */
    public CommandLineTool.Builder setLabel(CharSequence value) {
    ...
    /** Sets the value of the 'description' field */
    public CommandLineTool.Builder setDescription(CharSequence value) {
    ...
    /** Sets the value of the 'cwlVersion' field */
    public CommandLineTool.Builder setCwlVersion(CharSequence value) {
    ...
    /** Sets the value of the 'class$' field */
    public CommandLineTool.Builder setClass$(CharSequence value) {
    ...
    /** Sets the value of the 'baseCommand' field */
    public CommandLineTool.Builder setBaseCommand(Object value) {
    ...
    /** Sets the value of the 'arguments' field */
    public CommandLineTool.Builder setArguments(java.util.List<Object> value) {
    ...
    /** Sets the value of the 'stdin' field */
    public CommandLineTool.Builder setStdin(Object value) {
    ...
    /** Sets the value of the 'stdout' field */
    public CommandLineTool.Builder setStdout(Object value) {
    ...
    /** Sets the value of the 'successCodes' field */
    public CommandLineTool.Builder setSuccessCodes(java.util.List<Integer> value) {
    ...
    /** Sets the value of the 'temporaryFailCodes' field */
    public CommandLineTool.Builder setTemporaryFailCodes(java.util.List<Integer> value) {
    ...
    /** Sets the value of the 'permanentFailCodes' field */
    public CommandLineTool.Builder setPermanentFailCodes(java.util.List<Integer> value) {
    ...
    public CommandLineTool build() {
      try {
        ...
        record.baseCommand = fieldSetFlags()[9] ? this.baseCommand : (Object) defaultValue(fields()[9]);
        record.arguments = fieldSetFlags()[10] ? this.arguments : (java.util.List<Object>) defaultValue(fields()[10]);
        record.stdin = fieldSetFlags()[11] ? this.stdin : (Object) defaultValue(fields()[11]);
        record.stdout = fieldSetFlags()[12] ? this.stdout : (Object) defaultValue(fields()[12]);
        record.successCodes = fieldSetFlags()[13] ? this.successCodes : (java.util.List<Integer>) defaultValue(fields()[13]);
        record.temporaryFailCodes = fieldSetFlags()[14] ? this.temporaryFailCodes : (java.util.List<Integer>) defaultValue(fields()[14]);
        record.permanentFailCodes = fieldSetFlags()[15] ? this.permanentFailCodes : (java.util.List<Integer>) defaultValue(fields()[15]);
        return record;
      } catch (Exception e) {
