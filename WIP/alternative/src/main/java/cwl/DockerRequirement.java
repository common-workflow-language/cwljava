 ...
 */
   ...
   */
  public DockerRequirement(CharSequence class$, CharSequence dockerPull, CharSequence dockerLoad, CharSequence dockerFile, CharSequence dockerImport, CharSequence dockerImageId, CharSequence dockerOutputDirectory) {
    this.class$ = class$;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: dockerPull = (CharSequence)value$; break;
    case 2: dockerLoad = (CharSequence)value$; break;
    case 3: dockerFile = (CharSequence)value$; break;
    case 4: dockerImport = (CharSequence)value$; break;
    case 5: dockerImageId = (CharSequence)value$; break;
    case 6: dockerOutputDirectory = (CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * Specify a Docker image to retrieve using `docker pull`.   */
  public CharSequence getDockerPull() {
    return dockerPull;
  }
   ...
   */
  public void setDockerPull(CharSequence value) {
   ...
   * Specify a HTTP URL from which to download a Docker image using `docker load`.   */
  public CharSequence getDockerLoad() {
    return dockerLoad;
  }
   ...
   */
  public void setDockerLoad(CharSequence value) {
   ...
   * Supply the contents of a Dockerfile which will be built using `docker build`.   */
  public CharSequence getDockerFile() {
    return dockerFile;
  }
   ...
   */
  public void setDockerFile(CharSequence value) {
   ...
   * Provide HTTP URL to download and gunzip a Docker images using `docker import.   */
  public CharSequence getDockerImport() {
    return dockerImport;
  }
   ...
   */
  public void setDockerImport(CharSequence value) {
...
must be used.
   */
  public CharSequence getDockerImageId() {
...
must be used.
   ...
   */
  public void setDockerImageId(CharSequence value) {
...
Docker container.
   */
  public CharSequence getDockerOutputDirectory() {
...
Docker container.
   * @param value the value to set.
   */
  public void setDockerOutputDirectory(CharSequence value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DockerRequirement>
    ...
    private CharSequence dockerPull;
    private CharSequence dockerLoad;
    private CharSequence dockerFile;
    private CharSequence dockerImport;
    private CharSequence dockerImageId;
    private CharSequence dockerOutputDirectory;
    ...
    /** Sets the value of the 'class$' field */
    public DockerRequirement.Builder setClass$(CharSequence value) {
    ...
    /** Sets the value of the 'dockerPull' field */
    public DockerRequirement.Builder setDockerPull(CharSequence value) {
    ...
    /** Sets the value of the 'dockerLoad' field */
    public DockerRequirement.Builder setDockerLoad(CharSequence value) {
    ...
    /** Sets the value of the 'dockerFile' field */
    public DockerRequirement.Builder setDockerFile(CharSequence value) {
    ...
    /** Sets the value of the 'dockerImport' field */
    public DockerRequirement.Builder setDockerImport(CharSequence value) {
    ...
    /** Sets the value of the 'dockerImageId' field */
    public DockerRequirement.Builder setDockerImageId(CharSequence value) {
    ...
    /** Sets the value of the 'dockerOutputDirectory' field */
    public DockerRequirement.Builder setDockerOutputDirectory(CharSequence value) {
    ...
    public DockerRequirement build() {
      try {
        ...
        record.dockerPull = fieldSetFlags()[1] ? this.dockerPull : (CharSequence) defaultValue(fields()[1]);
        record.dockerLoad = fieldSetFlags()[2] ? this.dockerLoad : (CharSequence) defaultValue(fields()[2]);
        record.dockerFile = fieldSetFlags()[3] ? this.dockerFile : (CharSequence) defaultValue(fields()[3]);
        record.dockerImport = fieldSetFlags()[4] ? this.dockerImport : (CharSequence) defaultValue(fields()[4]);
        record.dockerImageId = fieldSetFlags()[5] ? this.dockerImageId : (CharSequence) defaultValue(fields()[5]);
        record.dockerOutputDirectory = fieldSetFlags()[6] ? this.dockerOutputDirectory : (CharSequence) defaultValue(fields()[6]);
        return record;
      } catch (Exception e) {
