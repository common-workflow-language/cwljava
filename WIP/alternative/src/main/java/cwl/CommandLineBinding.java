 ...
 */
   ...
   */
  public CommandLineBinding(Boolean loadContents, Object secondaryFiles, Integer position, CharSequence prefix, Boolean separate, CharSequence itemSeparator, Object valueFrom, Boolean shellQuote) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: position = (Integer)value$; break;
    case 3: prefix = (CharSequence)value$; break;
    case 4: separate = (Boolean)value$; break;
    case 5: itemSeparator = (CharSequence)value$; break;
    case 6: valueFrom = (Object)value$; break;
    case 7: shellQuote = (Boolean)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
...
should be applied to the primary file:
   ...
   */
  public void setPrefix(CharSequence value) {
    this.prefix = value;
  }
...
separated by by `itemSeparator`.
   */
  public CharSequence getItemSeparator() {
...
separated by by `itemSeparator`.
   * @param value the value to set.
   */
  public void setItemSeparator(CharSequence value) {
...
Use `shellQuote: false` to inject metacharacters for operations such as pipes.
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CommandLineBinding>
    ...
    private CharSequence itemSeparator;
    private Object valueFrom;
    private Boolean shellQuote;
    ...
    /** Sets the value of the 'loadContents' field */
    public CommandLineBinding.Builder setLoadContents(Boolean value) {
    ...
    /** Sets the value of the 'secondaryFiles' field */
    public CommandLineBinding.Builder setSecondaryFiles(Object value) {
    ...
    /** Sets the value of the 'position' field */
    public CommandLineBinding.Builder setPosition(Integer value) {
    ...
    /** Sets the value of the 'prefix' field */
    public CommandLineBinding.Builder setPrefix(CharSequence value) {
    ...
    /** Sets the value of the 'separate' field */
    public CommandLineBinding.Builder setSeparate(Boolean value) {
    ...
    /** Sets the value of the 'itemSeparator' field */
    public CommandLineBinding.Builder setItemSeparator(CharSequence value) {
    ...
    /** Sets the value of the 'valueFrom' field */
    public CommandLineBinding.Builder setValueFrom(Object value) {
    ...
    /** Sets the value of the 'shellQuote' field */
    public CommandLineBinding.Builder setShellQuote(Boolean value) {
    ...
    public CommandLineBinding build() {
      try {
        ...
        record.position = fieldSetFlags()[2] ? this.position : (Integer) defaultValue(fields()[2]);
        record.prefix = fieldSetFlags()[3] ? this.prefix : (CharSequence) defaultValue(fields()[3]);
        record.separate = fieldSetFlags()[4] ? this.separate : (Boolean) defaultValue(fields()[4]);
        record.itemSeparator = fieldSetFlags()[5] ? this.itemSeparator : (CharSequence) defaultValue(fields()[5]);
        record.valueFrom = fieldSetFlags()[6] ? this.valueFrom : (Object) defaultValue(fields()[6]);
        record.shellQuote = fieldSetFlags()[7] ? this.shellQuote : (Boolean) defaultValue(fields()[7]);
        return record;
      } catch (Exception e) {
