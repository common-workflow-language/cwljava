 ...
 */
   ...
   */
  public RecordField(CharSequence name, CharSequence doc, Object type) {
    this.name = name;
    this.doc = doc;
    this.type = type;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordField>
    ...
    /** Sets the value of the 'name' field */
    public RecordField.Builder setName(CharSequence value) {
    ...
    /** Sets the value of the 'doc' field */
    public RecordField.Builder setDoc(CharSequence value) {
    ...
    /** Sets the value of the 'type' field */
    public RecordField.Builder setType(Object value) {
