...
be called from CWL expressions.
 */
  @Deprecated public java.util.List<CharSequence> expressionLib;
   ...
   */
  public InlineJavascriptRequirement(CharSequence class$, java.util.List<CharSequence> expressionLib) {
    this.class$ = class$;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: expressionLib = (java.util.List<CharSequence>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
...
be called from CWL expressions.
   */
  public java.util.List<CharSequence> getExpressionLib() {
...
be called from CWL expressions.
   ...
   */
  public void setExpressionLib(java.util.List<CharSequence> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InlineJavascriptRequirement>
    ...
    private java.util.List<CharSequence> expressionLib;
    ...
    /** Sets the value of the 'class$' field */
    public InlineJavascriptRequirement.Builder setClass$(CharSequence value) {
    ...
    /** Sets the value of the 'expressionLib' field */
    public InlineJavascriptRequirement.Builder setExpressionLib(java.util.List<CharSequence> value) {
    ...
    public InlineJavascriptRequirement build() {
      try {
        ...
        record.expressionLib = fieldSetFlags()[1] ? this.expressionLib : (java.util.List<CharSequence>) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
