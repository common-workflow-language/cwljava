 ...
 */
   ...
   */
  public InputRecordField(CharSequence name, CharSequence doc, Object type, Binding inputBinding) {
    this.name = name;
    this.doc = doc;
    this.type = type;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InputRecordField>
    ...
    /** Sets the value of the 'name' field */
    public InputRecordField.Builder setName(CharSequence value) {
    ...
    /** Sets the value of the 'doc' field */
    public InputRecordField.Builder setDoc(CharSequence value) {
    ...
    /** Sets the value of the 'type' field */
    public InputRecordField.Builder setType(Object value) {
