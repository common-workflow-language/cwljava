...
matches the output parameters of the ExpressionTool.
 */
  @Deprecated public Object expression;
   ...
   */
  public ExpressionTool(CharSequence id, java.util.List<InputParameter> inputs, java.util.List<OutputParameter> outputs, java.util.List<Object> requirements, java.util.List<Any> hints, CharSequence label, CharSequence description, CharSequence cwlVersion, CharSequence class$, Object expression) {
    this.id = id;
    this.inputs = inputs;
  ...
  public void put(int field$, Object value$) {
    ...
    case 9: expression = (Object)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
...
matches the output parameters of the ExpressionTool.
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExpressionTool>
    ...
    /** Sets the value of the 'id' field */
    public ExpressionTool.Builder setId(CharSequence value) {
    ...
    /** Sets the value of the 'requirements' field */
    public ExpressionTool.Builder setRequirements(java.util.List<Object> value) {
    ...
    /** Sets the value of the 'label' field */
    public ExpressionTool.Builder setLabel(CharSequence value) {
    ...
    /** Sets the value of the 'description' field */
    public ExpressionTool.Builder setDescription(CharSequence value) {
    ...
    /** Sets the value of the 'cwlVersion' field */
    public ExpressionTool.Builder setCwlVersion(CharSequence value) {
    ...
    /** Sets the value of the 'class$' field */
    public ExpressionTool.Builder setClass$(CharSequence value) {
    ...
    /** Sets the value of the 'expression' field */
    public ExpressionTool.Builder setExpression(Object value) {
    ...
    public ExpressionTool build() {
      try {
        ...
        record.expression = fieldSetFlags()[9] ? this.expression : (Object) defaultValue(fields()[9]);
        return record;
      } catch (Exception e) {
