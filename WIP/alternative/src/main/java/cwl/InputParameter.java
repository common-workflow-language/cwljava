 ...
 */
   ...
   */
  public InputParameter(Object type, CharSequence label, CharSequence description, Boolean streamable, Any default$, CharSequence id, Binding inputBinding) {
    this.type = type;
    this.label = label;
...
into a concrete form for execution, such as command line parameters.
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InputParameter>
    ...
    /** Sets the value of the 'type' field */
    public InputParameter.Builder setType(Object value) {
    ...
    /** Sets the value of the 'label' field */
    public InputParameter.Builder setLabel(CharSequence value) {
    ...
    /** Sets the value of the 'description' field */
    public InputParameter.Builder setDescription(CharSequence value) {
    ...
    /** Sets the value of the 'streamable' field */
    public InputParameter.Builder setStreamable(Boolean value) {
    ...
    /** Sets the value of the 'id' field */
    public InputParameter.Builder setId(CharSequence value) {
