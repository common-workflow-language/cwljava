...
public class SchemaDefRequirement extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<Object> types;
   ...
   */
  public SchemaDefRequirement(CharSequence class$, java.util.List<Object> types) {
    this.class$ = class$;
    this.types = types;
  }
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: types = (java.util.List<Object>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public void setTypes(java.util.List<Object> value) {
    this.types = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SchemaDefRequirement>
    ...
    /** Sets the value of the 'class$' field */
    public SchemaDefRequirement.Builder setClass$(CharSequence value) {
    ...
    /** Sets the value of the 'types' field */
    public SchemaDefRequirement.Builder setTypes(java.util.List<Object> value) {
    ...
    public SchemaDefRequirement build() {
      try {
        ...
        record.types = fieldSetFlags()[1] ? this.types : (java.util.List<Object>) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
