 ...
 */
   ...
   */
  public WorkflowStepInput(Object source, LinkMergeMethod linkMerge, CharSequence id, Any default$) {
    this.source = source;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: source = (Object)value$; break;
...
field.
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WorkflowStepInput>
    ...
    /** Sets the value of the 'source' field */
    public WorkflowStepInput.Builder setSource(Object value) {
    ...
    /** Sets the value of the 'id' field */
    public WorkflowStepInput.Builder setId(CharSequence value) {
    ...
    public WorkflowStepInput build() {
      try {
        ...
        record.source = fieldSetFlags()[0] ? this.source : (Object) defaultValue(fields()[0]);
