 ...
 */
   ...
   */
  public OutputParameter(Object type, CharSequence label, CharSequence description, Boolean streamable, Any default$, CharSequence id, Binding outputBinding) {
    this.type = type;
    this.label = label;
...
object.
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OutputParameter>
    ...
    /** Sets the value of the 'type' field */
    public OutputParameter.Builder setType(Object value) {
    ...
    /** Sets the value of the 'label' field */
    public OutputParameter.Builder setLabel(CharSequence value) {
    ...
    /** Sets the value of the 'description' field */
    public OutputParameter.Builder setDescription(CharSequence value) {
    ...
    /** Sets the value of the 'streamable' field */
    public OutputParameter.Builder setStreamable(Boolean value) {
    ...
    /** Sets the value of the 'id' field */
    public OutputParameter.Builder setId(CharSequence value) {
