...
"sha1$ + hexidecimal string" using the SHA-1 algorithm.
 */
  @Deprecated public CharSequence checksum;
  /** Optional file size. */
 ...
 */
   ...
   */
  public File(File_class class$, CharSequence path, CharSequence checksum, Long size, java.util.List<File> secondaryFiles) {
    this.class$ = class$;
    this.path = path;
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: checksum = (CharSequence)value$; break;
    case 3: size = (Long)value$; break;
...
"sha1$ + hexidecimal string" using the SHA-1 algorithm.
   ...
   */
  public void setChecksum(CharSequence value) {
    this.checksum = value;
  }
...
rules apply.
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<File>
    ...
    /** Sets the value of the 'path' field */
    public File.Builder setPath(CharSequence value) {
    ...
    /** Sets the value of the 'checksum' field */
    public File.Builder setChecksum(CharSequence value) {
    ...
    public File build() {
      try {
        ...
        record.checksum = fieldSetFlags()[2] ? this.checksum : (CharSequence) defaultValue(fields()[2]);
        record.size = fieldSetFlags()[3] ? this.size : (Long) defaultValue(fields()[3]);
