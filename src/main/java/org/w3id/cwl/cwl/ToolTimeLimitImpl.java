...
/**
 * Auto-generated class implementation for <I>https://w3id.org/cwl/cwl#ToolTimeLimit</I><br>
 *
 * <BLOCKQUOTE>
 *
...
public class ToolTimeLimitImpl extends SavableImpl implements ToolTimeLimit {
  ...
  /**
   * Used by {@link org.w3id.cwl.cwl.utils.RootLoader} to construct instances of ToolTimeLimitImpl.
   *
  ...
  public ToolTimeLimitImpl(
    ...
    try {
      timelimit =
          LoaderInstances.union_of_LongInstance_or_Expression.loadField(
              __doc.get("timelimit"), __baseUri, __loadingOptions);
    } catch (ValidationException e) {
