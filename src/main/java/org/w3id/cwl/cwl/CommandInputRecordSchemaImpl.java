...
/**
 * Auto-generated class implementation for <I>https://w3id.org/cwl/cwl#CommandInputRecordSchema</I>
 * <br>
 */
public class CommandInputRecordSchemaImpl extends SavableImpl implements CommandInputRecordSchema {
  ...
  public CommandInputRecordSchemaImpl(
    ...
    if (__doc.containsKey("fields")) {
      try {
        fields =
            LoaderInstances.idmap_fields_optional_array_of_CommandInputRecordField.loadField(
