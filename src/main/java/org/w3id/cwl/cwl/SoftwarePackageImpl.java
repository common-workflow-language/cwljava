...
public class SoftwarePackageImpl extends SavableImpl implements SoftwarePackage {
  ...
  public SoftwarePackageImpl(
    ...
    try {
      package_ =
          LoaderInstances.StringInstance.loadField(
              __doc.get("package"), __baseUri, __loadingOptions);
      ...
      try {
        version =
            LoaderInstances.optional_array_of_StringInstance.loadField(
                __doc.get("version"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("specs")) {
      try {
        specs =
            LoaderInstances.uri_optional_array_of_StringInstance_False_False_None.loadField(
                __doc.get("specs"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
