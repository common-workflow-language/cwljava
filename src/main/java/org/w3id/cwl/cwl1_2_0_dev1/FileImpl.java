...
/**
 * Auto-generated class implementation for <I>https://w3id.org/cwl/cwl#File</I><br>
 *
 * <BLOCKQUOTE>
 *
...
public class FileImpl extends SavableImpl implements File {
  ...
  /**
   * Used by {@link org.w3id.cwl.cwl1_2_0_dev1.utils.RootLoader} to construct instances of FileImpl.
   *
  ...
  public FileImpl(
    ...
    try {
      class_ =
          LoaderInstances.uri_File_class_False_True_None.loadField(
    ...
    if (__doc.containsKey("dirname")) {
      try {
        dirname =
            LoaderInstances.optional_StringInstance.loadField(
                __doc.get("dirname"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("nameroot")) {
      try {
        nameroot =
            LoaderInstances.optional_StringInstance.loadField(
                __doc.get("nameroot"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("nameext")) {
      try {
        nameext =
            LoaderInstances.optional_StringInstance.loadField(
                __doc.get("nameext"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("checksum")) {
      try {
        checksum =
            LoaderInstances.optional_StringInstance.loadField(
                __doc.get("checksum"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("size")) {
      try {
        size =
            LoaderInstances.optional_LongInstance.loadField(
                __doc.get("size"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
      ...
      try {
        secondaryFiles =
            LoaderInstances.optional_array_of_union_of_File_or_Directory.loadField(
                __doc.get("secondaryFiles"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("contents")) {
      try {
        contents =
            LoaderInstances.optional_StringInstance.loadField(
                __doc.get("contents"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
