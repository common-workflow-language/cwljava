...
public class LoaderInstances {
  ...
  public static Loader<Object> union_of_NullInstance_or_StringInstance_or_array_of_StringInstance_or_Expression = new UnionLoader(new Loader[] { NullInstance, StringInstance, array_of_StringInstance, Expression });
  public static Loader<Object> uri_union_of_NullInstance_or_StringInstance_or_array_of_StringInstance_or_Expression_True_False_None = new UriLoader(union_of_NullInstance_or_StringInstance_or_array_of_StringInstance_or_Expression, true, false, null);
  public static Loader<Object> union_of_NullInstance_or_StringInstance_or_Expression = new UnionLoader(new Loader[] { NullInstance, StringInstance, Expression });
  public static Loader<Object> uri_union_of_NullInstance_or_StringInstance_or_Expression_True_False_None = new UriLoader(union_of_NullInstance_or_StringInstance_or_Expression, true, false, null);
  ...
  public static Loader<Object> union_of_StringInstance_or_Expression = new UnionLoader(new Loader[] { StringInstance, Expression });
  public static Loader<Object> union_of_NullInstance_or_BooleanInstance_or_Expression = new UnionLoader(new Loader[] { NullInstance, BooleanInstance, Expression });
  ...
  public static Loader<Object> union_of_NullInstance_or_IntegerInstance_or_Expression = new UnionLoader(new Loader[] { NullInstance, IntegerInstance, Expression });
  public static Loader<Object> union_of_NullInstance_or_StringInstance_or_Expression_or_array_of_StringInstance = new UnionLoader(new Loader[] { NullInstance, StringInstance, Expression, array_of_StringInstance });
  public static Loader<java.util.Optional<Expression>> optional_Expression = new OptionalLoader(Expression);
  ...
  public static Loader<Object> union_of_StringInstance_or_Expression_or_CommandLineBinding = new UnionLoader(new Loader[] { StringInstance, Expression, CommandLineBinding });
  public static Loader<java.util.List<Object>> array_of_union_of_StringInstance_or_Expression_or_CommandLineBinding = new ArrayLoader(union_of_StringInstance_or_Expression_or_CommandLineBinding);
  public static Loader<java.util.Optional<java.util.List<Object>>> optional_array_of_union_of_StringInstance_or_Expression_or_CommandLineBinding = new OptionalLoader(array_of_union_of_StringInstance_or_Expression_or_CommandLineBinding);
  ...
  public static Loader<Object> union_of_NullInstance_or_Dirent_or_Expression_or_File_or_Directory_or_array_of_union_of_File_or_Directory = new UnionLoader(new Loader[] { NullInstance, Dirent, Expression, File, Directory, array_of_union_of_File_or_Directory });
  public static Loader<java.util.List<Object>> array_of_union_of_NullInstance_or_Dirent_or_Expression_or_File_or_Directory_or_array_of_union_of_File_or_Directory = new ArrayLoader(union_of_NullInstance_or_Dirent_or_Expression_or_File_or_Directory_or_array_of_union_of_File_or_Directory);
  public static Loader<Object> union_of_Expression_or_array_of_union_of_NullInstance_or_Dirent_or_Expression_or_File_or_Directory_or_array_of_union_of_File_or_Directory = new UnionLoader(new Loader[] { Expression, array_of_union_of_NullInstance_or_Dirent_or_Expression_or_File_or_Directory_or_array_of_union_of_File_or_Directory });
  ...
  public static Loader<Object> union_of_NullInstance_or_LongInstance_or_FloatInstance_or_Expression = new UnionLoader(new Loader[] { NullInstance, LongInstance, FloatInstance, Expression });
  ...
  public static Loader<Object> union_of_BooleanInstance_or_Expression = new UnionLoader(new Loader[] { BooleanInstance, Expression });
  ...
  public static Loader<Object> union_of_LongInstance_or_Expression = new UnionLoader(new Loader[] { LongInstance, Expression });
