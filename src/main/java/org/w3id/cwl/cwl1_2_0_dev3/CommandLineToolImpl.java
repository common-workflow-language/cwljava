...
/**
 * Auto-generated class implementation for <I>https://w3id.org/cwl/cwl#CommandLineTool</I><br>
 *
 * <BLOCKQUOTE>
 *
...
public class CommandLineToolImpl extends SavableImpl implements CommandLineTool {
  ...
  public CommandLineToolImpl(
    ...
    try {
      inputs =
          LoaderInstances.idmap_inputs_array_of_CommandInputParameter.loadField(
    ...
    try {
      outputs =
          LoaderInstances.idmap_outputs_array_of_CommandOutputParameter.loadField(
      ...
      try {
        stdin =
            LoaderInstances.union_of_NullInstance_or_StringInstance_or_Expression.loadField(
                __doc.get("stdin"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("stderr")) {
      try {
        stderr =
            LoaderInstances.union_of_NullInstance_or_StringInstance_or_Expression.loadField(
                __doc.get("stderr"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("stdout")) {
      try {
        stdout =
            LoaderInstances.union_of_NullInstance_or_StringInstance_or_Expression.loadField(
                __doc.get("stdout"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("successCodes")) {
      try {
        successCodes =
            LoaderInstances.optional_array_of_IntegerInstance.loadField(
                __doc.get("successCodes"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("temporaryFailCodes")) {
      try {
        temporaryFailCodes =
            LoaderInstances.optional_array_of_IntegerInstance.loadField(
                __doc.get("temporaryFailCodes"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("permanentFailCodes")) {
      try {
        permanentFailCodes =
            LoaderInstances.optional_array_of_IntegerInstance.loadField(
                __doc.get("permanentFailCodes"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
