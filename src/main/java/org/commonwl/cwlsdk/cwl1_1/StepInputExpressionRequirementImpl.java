...
/**
* Auto-generated class implementation for <I>https://w3id.org/cwl/cwl#StepInputExpressionRequirement</I><BR> <BLOCKQUOTE>
 Indicate that the workflow platform must support the `valueFrom` field
 of [WorkflowStepInput](#WorkflowStepInput).
  </BLOCKQUOTE>
 */
public class StepInputExpressionRequirementImpl extends SaveableImpl implements StepInputExpressionRequirement {
  ...
  private StepInputExpressionRequirement_class class_;
  ...
  /**
   * Used by {@link org.commonwl.cwlsdk.cwl1_1.utils.RootLoader} to construct instances of StepInputExpressionRequirementImpl.
   *
  ...
  public StepInputExpressionRequirementImpl(
    ...
    StepInputExpressionRequirement_class class_;
    try {
      class_ =
          LoaderInstances
    ...
    this.class_ = (StepInputExpressionRequirement_class) class_;
  ...
  private java.util.List<String> attrs = java.util.Arrays.asList("class");
}
