...
/**
* Auto-generated class implementation for <I>https://w3id.org/cwl/cwl#OutputRecordField</I><BR>
 */
public class OutputRecordFieldImpl extends SaveableImpl implements OutputRecordField {
  ...
  /**
   * Used by {@link org.commonwl.cwlsdk.cwl1_1.utils.RootLoader} to construct instances of OutputRecordFieldImpl.
   *
  ...
  public OutputRecordFieldImpl(
    ...
    if (!(__doc_ instanceof java.util.Map)) {
      throw new ValidationException("OutputRecordFieldImpl called on non-map");
    }
  ...
  private java.util.List<String> attrs = java.util.Arrays.asList("doc", "name", "type", "label", "secondaryFiles", "streamable", "format");
}
