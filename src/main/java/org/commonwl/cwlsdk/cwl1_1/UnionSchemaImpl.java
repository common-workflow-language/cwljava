...
public class UnionSchemaImpl extends SaveableImpl implements UnionSchema {
  ...
  /**
   * Used by {@link org.commonwl.cwlsdk.cwl1_1.utils.RootLoader} to construct instances of UnionSchemaImpl.
   *
  ...
  private java.util.List<String> attrs = java.util.Arrays.asList("names", "type");
}
