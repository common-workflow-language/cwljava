...
/**
* Auto-generated class implementation for <I>https://w3id.org/cwl/cwl#SoftwareRequirement</I><BR> <BLOCKQUOTE>
 A list of software packages that should be configured in the environment of
 the defined process.
  </BLOCKQUOTE>
 */
public class SoftwareRequirementImpl extends SaveableImpl implements SoftwareRequirement {
  ...
  /**
   * Used by {@link org.commonwl.cwlsdk.cwl1_1.utils.RootLoader} to construct instances of SoftwareRequirementImpl.
   *
  ...
  public SoftwareRequirementImpl(
    ...
    try {
      packages =
          LoaderInstances
              .idmap_packages_array_of_SoftwarePackage
              .loadField(__doc.get("packages"), __baseUri, __loadingOptions);
    } catch (ValidationException e) {
  ...
  private java.util.List<String> attrs = java.util.Arrays.asList("class", "packages");
}
