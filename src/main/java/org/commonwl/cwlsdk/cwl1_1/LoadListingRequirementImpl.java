...
public class LoadListingRequirementImpl extends SaveableImpl implements LoadListingRequirement {
  ...
  /**
   * Used by {@link org.commonwl.cwlsdk.cwl1_1.utils.RootLoader} to construct instances of LoadListingRequirementImpl.
   *
  ...
  private java.util.List<String> attrs = java.util.Arrays.asList("class", "loadListing");
}
