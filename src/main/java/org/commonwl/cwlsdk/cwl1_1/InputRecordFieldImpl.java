 ...
 */
public class InputRecordFieldImpl extends SaveableImpl implements InputRecordField {
  ...
  /**
   * Used by {@link org.commonwl.cwlsdk.cwl1_1.utils.RootLoader} to construct instances of InputRecordFieldImpl.
   *
  ...
  private java.util.List<String> attrs = java.util.Arrays.asList("doc", "name", "type", "label", "secondaryFiles", "streamable", "format", "loadContents", "loadListing");
}
