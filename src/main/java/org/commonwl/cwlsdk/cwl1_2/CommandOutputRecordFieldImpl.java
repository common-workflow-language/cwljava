 ...
 */
public class CommandOutputRecordFieldImpl extends SaveableImpl implements CommandOutputRecordField {
  ...
  /**
   * Used by {@link org.commonwl.cwlsdk.cwl1_2.utils.RootLoader} to construct instances of CommandOutputRecordFieldImpl.
   *
  ...
  private java.util.List<String> attrs = java.util.Arrays.asList("doc", "name", "type", "label", "secondaryFiles", "streamable", "format", "outputBinding");
}
