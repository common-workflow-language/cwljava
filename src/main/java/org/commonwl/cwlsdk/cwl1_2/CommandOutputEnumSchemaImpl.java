...
/**
* Auto-generated class implementation for <I>https://w3id.org/cwl/cwl#CommandOutputEnumSchema</I><BR>
 */
public class CommandOutputEnumSchemaImpl extends SaveableImpl implements CommandOutputEnumSchema {
  ...
  /**
   * Used by {@link org.commonwl.cwlsdk.cwl1_2.utils.RootLoader} to construct instances of CommandOutputEnumSchemaImpl.
   *
   ...
   */
  public CommandOutputEnumSchemaImpl(
      final Object __doc_,
    ...
    if (!(__doc_ instanceof java.util.Map)) {
      throw new ValidationException("CommandOutputEnumSchemaImpl called on non-map");
    }
  ...
  private java.util.List<String> attrs = java.util.Arrays.asList("name", "symbols", "type", "label", "doc");
}
