            ...
            "steps": [
                {
                    ...
                    "run": {
                        ...
                        "outputs": [
                            {
                                "type": "int",
                                "outputSource": "#main/step1/run/step2/count_output",
                        ...
                        "steps": [
                            ...
                            },
                            {
                                ...
                                "out": [
                                    "#main/step1/run/step2/count_output"
                                ],
                                "run": {
                                    "class": "Workflow",
                                    "inputs": [
                                        {
                                            "type": "File",
                                            "id": "#main/step1/run/step2/run/file1"
                                        }
                                    ],
                                    "outputs": [
                                        {
                                            "type": "int",
                                            "outputSource": "#main/step1/run/step2/run/step1/output",
                                            "id": "#main/step1/run/step2/run/count_output"
                                        }
                                    ],
                                    "steps": [
                                        {
                                            ...
                                            "in": [
                                                {
                                                    "source": "#main/step1/run/step2/run/file1",
                                                    "id": "#main/step1/run/step2/run/step1/file1"
                                                }
                                            ],
                                            "out": [
                                                "#main/step1/run/step2/run/step1/output"
                                            ],
                                            "id": "#main/step1/run/step2/run/step1"
                                        }
                                    ]
                                },
