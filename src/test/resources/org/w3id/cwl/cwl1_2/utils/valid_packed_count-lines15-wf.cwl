            ...
            "steps": [
                {
                    ...
                    "run": {
                        ...
                        "outputs": [
                            {
                                "type": "int",
                                "outputSource": "#main/step1/run/step1/count_output",
                        ...
                        "steps": [
                            {
                                ...
                                "out": [
                                    "#main/step1/run/step1/count_output"
                                ],
                                "run": {
                                    "class": "Workflow",
                                    "inputs": [
                                    ...
                                    "outputs": [
                                        {
                                            "type": "int",
                                            "outputSource": "#main/step1/run/step1/run/step2/output",
                                            "id": "#main/step1/run/step1/run/count_output"
                                        }
                                    ],
                                    "steps": [
                                        {
                                        ...
                                        },
                                        {
                                            ...
                                            "in": [
                                                {
                                                    "source": "#main/step1/run/step1/run/step1/output",
                                                    "id": "#main/step1/run/step1/run/step2/file1"
                                                }
                                            ],
                                            "out": [
                                                "#main/step1/run/step1/run/step2/output"
                                            ],
                                            "id": "#main/step1/run/step1/run/step2"
                                        }
                                    ]
                                },
