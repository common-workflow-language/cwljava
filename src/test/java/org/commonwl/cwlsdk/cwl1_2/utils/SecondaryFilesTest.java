...
import org.commonwl.cwlsdk.cwl1_2.Process;
import org.commonwl.cwlsdk.cwl1_2.SecondaryFileSchema;
import org.commonwl.cwlsdk.cwl1_2.Workflow;
import org.commonwl.cwlsdk.cwl1_2.WorkflowInputParameter;
...
public class SecondaryFilesTest {
  ...
  public SecondaryFilesTest() throws URISyntaxException {
    ...
    this.doc =
        (List<Process>)
            RootLoader.loadDocument(Paths.get(getClass().getResource("525.cwl").toURI()));
  }
